...
All Jetson Orin boards in this repository tagged v8.0.0 and newer are using L4T 39.2 - Jetpack 7.2.

balenaOS production images for Jetson devices at versions greater than v6.0 are based on Jetpack 6.
balenaOS production images for Jetson devices at versions greater than v8.0.0 are based on Jetpack 7.2.

IMPORTANT:

Updating from Jetpack 6 to Jetpack 7 requires devices to be running L4T 36.5.0 - Jetpack 6.2.2. Please update your
units to v7.9.4 before updating to v8.0.0 or newer, otherwise the OS update will fail.
